...
export const AddTimerModal: React.FC<AddTimerModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50">
      <div className="bg-white rounded-lg w-full max-w-sm sm:max-w-md max-h-[90vh] overflow-y-auto sm:h-auto sm:p-4 p-2 shadow-xl flex flex-col justify-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col justify-between">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full py-2 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
                />
              </div>
              <div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <ModalButton
              type="submit"
              className={`text-white ${isTitleValid && isTimeValid ? 'bg-blue-600 hover:bg-green-700' : 'bg-blue-400'}`}
            >
              Add Timer
            </ModalButton>
          </div>
